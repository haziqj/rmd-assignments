\documentclass[$if(answers)$answers,$endif$$if(fontsize)$$fontsize$,$endif$$if(lang)$$babel-lang$,$endif$$if(papersize)$$papersize$,$endif$$for(classoption)$$classoption$$sep$,$endfor$addpoints]{exam}
...
% https://stackoverflow.com/questions/53577496/running-code-chunk-in-r-markdown-using-exam-document-class
% \newcommand{\beginquestions}{\begin{questions}}
% \newcommand{\endquestions}{\end{questions}}
% \newcommand{\beginparts}{\begin{parts}}
% \newcommand{\endparts}{\end{parts}}
% \newcommand{\beginsolution}{\begin{solution}}
% \newcommand{\endsolution}{\end{solution}}

% Fancy questions inside a box--usage is \begin{fancyquestion} \end{fancyquestion}
\usepackage[most]{tcolorbox}
\newtcolorbox[auto counter]{fancyquestion}[1][]{colback=white, colframe=black,
...
\begin{center}
  ...
  $if(duedate)$ \\ \normalsize Due date: $duedate$ $endif$
\end{center}
